  ...
  context: {
    ...
    remittances: {
      ...
      indicators: [
        ...
        { term: "vs. state budget", value: "≈51%", sub: "of 2024 executed state budget revenue (66.98bn MDL); $1.92bn × ~17.7 MDL/USD", world: null, icon: "landmark", source_id: "mof_budget", def_id: "budget_ratio" }
      ]
    },
    emigration_flow: {
